---
name: oracle
description: Read-only architecture consultant for complex decisions, hard debugging, and self-review. Use for multi-system tradeoffs, after 2+ failed fix attempts, or unfamiliar code patterns. (Oracle - SisyClaude Plugin)
